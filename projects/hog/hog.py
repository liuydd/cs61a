...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    previous_score, previous_high=0,0
    def say(score0,score1):
         nonlocal previous_score, previous_high
         if who==0:
             adding_points=score0-previous_score
             previous_score=score0
         elif who==1:
             adding_points=score1-previous_score
             previous_score=score1
         if adding_points>previous_high:
             previous_high=adding_points
             a=str(adding_points)+" point(s)! That's a record gain for Player "+str(who)+"!"
             #a=str(who)+"!"
             #print(adding_points,"point(s)!","That's a record gain for Player",a)
             b=a.lstrip()
             print(b)
         return announce_highest(who,previous_score,previous_high)
    return say
    # END PROBLEM 7
