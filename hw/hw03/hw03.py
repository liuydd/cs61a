...
def count_coins(change):
    ...
    def count_nums(change,y):
        if change<0:
            return 0
        elif y==1 or change==0:
            return 1
        else:
            return count_nums(change-y,y)+count_nums(change,descending_coin(y))
    return count_nums(change,descending_coin(change))
    #to be continued
